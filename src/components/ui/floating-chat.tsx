  ...
  return (
    <div className="hidden lg:block">
      {isPanelOpen ? (
        ...
        <div
          className="fixed bottom-0 right-6 z-50 w-[400px] h-[520px] max-h-[calc(100dvh-6rem)] bg-white border border-b-0 border-brand-gray-100 shadow-2xl flex flex-col overflow-hidden rounded-t-2xl flat-bottom"
        >
          {/* Header */}
          <div className="flex items-center justify-between px-3 py-2.5 border-b border-brand-gray-100 bg-brand-red shrink-0">
        ...
        <button
          onClick={() => openPanel()}
          title="Buka Pesan"
          className="fixed bottom-0 right-6 z-50 flex items-center gap-2 bg-brand-red hover:bg-brand-red-dark text-white font-bold text-sm pl-4 pr-5 py-2.5 shadow-lg transition-colors rounded-t-xl flat-bottom"
        >
