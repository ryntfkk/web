        ...
        <div className="bg-white rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.04)] border border-brand-gray-80 overflow-hidden mb-6 relative group transition-all duration-300 hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)]">
          ...
          <div className="px-4 pb-4 md:px-5 md:pb-5">
            <button
              ...
              disabled={switching}
              className={`w-full relative overflow-hidden group rounded-xl font-bold text-sm py-3 px-4 transition-all duration-300 flex items-center justify-center gap-2 ${user.active_role === 'partner'
