...
export default function AboutSection({ profile }: AboutSectionProps) {
  ...
  return (
    <div className="bg-white rounded p-4 sm:p-6 shadow-sm mb-4 sm:mb-6">
      <h2 className="text-lg sm:text-xl font-semibold text-brand-gray-900 mb-3">Tentang Saya</h2>
      <div className="text-brand-gray-700 text-sm sm:text-base leading-relaxed whitespace-pre-line">
        {bioText}
      </div>
    </div>
  );
