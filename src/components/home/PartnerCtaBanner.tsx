  ...
  return (
    <section className="mb-6 md:mb-8">
      <Link
        ...
        className="group relative block overflow-hidden rounded-2xl bg-brand-gray-900 p-5 text-white transition-all hover:shadow-2xl hover:shadow-brand-red/20 sm:p-8"
      >
        ...
        <div className="relative z-10 flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between sm:gap-6">
          <div className="min-w-0 flex-1">
            <div className="mb-3 inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[10px] sm:text-[11px] font-semibold uppercase tracking-widest text-brand-red-light backdrop-blur-sm shadow-sm">
              <Sparkles className="h-3.5 w-3.5" /> Peluang Terbuka
            </div>
            
            <h2 className="mt-1 sm:mt-1.5 text-[20px] sm:text-[26px] font-extrabold leading-[1.2] tracking-tight">
              Punya keahlian? <br className="hidden sm:block" />
              <span className="text-white/90">Pasang jasa Anda di Posko.</span>
            </h2>
            
            <ul className="mt-5 flex flex-col gap-2.5 sm:mt-6 sm:flex-row sm:flex-wrap sm:gap-3">
              {POIN.map(({ Icon, teks }) => (
                <li key={teks} className="flex items-center gap-2.5 rounded-xl border border-white/5 bg-white/5 px-3.5 py-2.5 text-[11px] sm:text-[12px] font-medium text-white/90 backdrop-blur-sm transition-colors group-hover:border-white/10 group-hover:bg-white/10">
                  <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-brand-red/20 text-brand-red-light">
          ...
          <span className="mt-2 inline-flex w-full sm:mt-0 sm:w-auto shrink-0 items-center justify-center gap-2 rounded-xl bg-brand-red px-5 py-3.5 text-[13px] sm:text-[14px] font-bold text-white shadow-lg shadow-brand-red/20 transition-all group-hover:-translate-y-0.5 group-hover:bg-brand-red-dark group-hover:shadow-brand-red/40 sm:px-6">
