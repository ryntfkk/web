...
export default function LocationNotice() {
  ...
  return (
    <div className="mb-5 sm:mb-6 flex items-start gap-3 rounded-xl border border-[#FEB2B2] bg-[#FFF5F5] p-3 sm:p-4">
      <div className="w-9 h-9 rounded-full bg-white flex items-center justify-center shrink-0 text-[#b51822]">
        <MapPinOff className="w-4.5 h-4.5" />
      </div>
      <div className="flex-1 min-w-0">
        <p className="text-[13px] sm:text-[14px] font-semibold text-[#1c1b1b]">
          Lokasi tidak aktif — jarak tidak ditampilkan
        </p>
        <p className="text-[12px] text-[#5b403e] mt-0.5 leading-snug">
          {denied
      ...
      <div className="flex flex-col gap-1.5 shrink-0">
        <button
          type="button"
          onClick={retry}
          className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#b51822] text-white text-[12px] font-semibold hover:bg-[#90121a] transition-colors"
        >
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-1 px-3 py-1 rounded-lg text-[11px] font-medium text-[#8f6f6d] hover:text-[#1c1b1b]"
        >
