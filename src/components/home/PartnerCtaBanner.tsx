  ...
  return (
    <section className="mb-6 md:mb-8">
      <Link
        ...
        className="group relative block overflow-hidden rounded-2xl bg-brand-gray-900 p-4 sm:p-5 lg:p-6 text-white transition-all hover:shadow-2xl hover:shadow-brand-red/20"
      >
        ...
        <div className="relative z-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between sm:gap-5">
          <div className="min-w-0 flex-1">
            ...
            <h2 className="mt-0.5 sm:mt-1 text-[17px] sm:text-[20px] lg:text-[22px] font-extrabold leading-[1.25] tracking-tight">
          ...
          <span className="inline-flex w-full sm:w-auto shrink-0 items-center justify-center gap-2 rounded-xl bg-brand-red px-4 py-2.5 sm:px-5 sm:py-2.5 lg:px-6 lg:py-3 text-[12px] sm:text-[13px] lg:text-[14px] font-bold text-white shadow-lg shadow-brand-red/20 transition-all group-hover:-translate-y-0.5 group-hover:bg-brand-red-dark group-hover:shadow-brand-red/40">
