...
const CATEGORIES = [
  { name: 'Reparasi AC', icon: '❄️', count: 24 },
  { name: 'Kelistrikan', icon: '⚡', count: 18 },
  { name: 'Saluran Air', icon: '🚰', count: 15 },
  { name: 'Kebersihan', icon: '🧹', count: 32 },
  { name: 'Peralatan Rumah', icon: '📺', count: 12 },
